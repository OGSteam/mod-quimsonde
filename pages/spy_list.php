...
<fieldset>
    ...
    if ($max_spy > 0) {
        ...
        // 1ere ligne
        $entete_tableau = array(
            array('class' => 'd',    'sort' => '',                    'label' => '&nbsp;',        'width' => '20'),
...
<?php
function make_changepage_table($pub_pagenum, $max_page, $string_url)
{    // Tableau pour les boutons de changement de page
    global $lang;
