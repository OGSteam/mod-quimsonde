...
if ($max_spy>0) {
	// 1, 2 ou 3 ?
	if ($max_spy>3) {
        $nb_last=3;$s_1='des 3';$s_0='s';
    } elseif ($max_spy>2) {
        $nb_last=2;$s_1='des 2';$s_0='s';
    } else {
        $nb_last=1;$s_1='du';$s_0='';
    }
	...
	// Titre
	echo"<tr><td class='l' colspan='4'>".
    ($nb_last==1 ? $lang['qms_le_dernier']:sprintf($lang['qms_les3derniers'], $nb_last)).
    "</td></tr>\n";

	// Pour le, les 2 ou les 3 espionnages
	for ($j=0; $j<$nb_last; $j++) {
        echo make_spy_OGameStyle($table_spy, $j);
    }
